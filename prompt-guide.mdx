...
Like with many LLM-powered tools, it can be hard to know exactly what you can do with Greptile. This page goes over some usecases that we have seen developers enjoy. While this guide is mainly meant for our [codebase Q&A web app](https://app.greptile.com) it applies to all other interfaces as well, including the API. 


### Understanding complex codebases

<Info>Example transcript: [Adding new keybindings to a VS Code extension](https://app.greptile.com/share/5c48c84e-66ae-4bbd-a64f-dfebe51654bc)</Info>
...
<Info>Example transcript: [Debugging an issue in Ubicloud](https://app.greptile.com/share/82e6d3d4-6a92-4528-a1a7-4fab1579577f)</Info>
...
<Info>Example transcript: [Adding support for custom SQL in Prisma](https://app.greptile.com/share/0acd4503-57c4-42ed-a239-262872a69c42)</Info>
...
<Info>Example transcript: [Integrating Helicone with NextAuth](https://app.greptile.com/share/9ed963b3-d496-4eff-af12-6243b0249d94)</Info>
...
<Info>Example transcript: [Finding ways reduce latency in Helicone proxies](https://app.greptile.com/share/c97ece75-c222-47f4-bc92-5f21ba9dde12)</Info>

Greptile can help find oppurtinities for performance and security improvements. Simply point it to a file or directory, and ask!
...
Like with all LLM prompting, you will discover subtelties over time about how to make Greptile work best with your codebase and your usecase. If you would like to report a prompting quirk, [tell us!](mailto:support@greptile.com) It helps us make Greptile better.