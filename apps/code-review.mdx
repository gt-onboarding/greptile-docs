...
You can grab your global settings in the correct format [here](https://app.greptile.com/review/) by clicking on the `copy` or `download` icons on the top right of the Settings panel. 
