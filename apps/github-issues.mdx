...
Click [here](https://app.greptile.com/) to install the GitHub Issue bot. Once you have installed the bot, you can use the same link to configure the bot. You can find a more detailed guide on how to install the bot in the [Code Review Bot documentation](/apps/code-review).
...
Click [here](https://app.greptile.com) to install the GitHub Issues bot.
