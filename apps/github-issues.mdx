...
description: 'Greptile add comments with helpful codebase context to your GitHub Issues'
---
...
Click [here](https://app.greptile.com/apps/github) to install the GitHub Issue bot. Once you have installed the bot, you can use the same link to configure the bot. 
