...
<CardGroup cols={3}>
  ...
  >
    ...
    icon="plug"
  >
  Connect Greptile to [Slack](/apps/slackbot) to answer questions about your codebase. Add it to [Linear](/apps/linear) to add codebase-context to every issue. Add it to GitHub to [review your PRs](/apps/github-pr). 
 </Card>
